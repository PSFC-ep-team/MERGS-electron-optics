...
p_detector_position := 0.516778196755042;
p_detector_tilt := -.119612324797750E-02;
p_detector_curvature := -1.52634612637570;

dipole_bend_angle :=  53.1174611978831;
dipole_max_bend_radius := 0.303727340408330;
dipole_central_bend_radius := 0.192035599051517;
dipole_min_bend_radius := 0.119475916512191;
dipole_gap_height := 0.700209017280884E-01;
detector_right := 0.198789218377727;
detector_left := 0.106844753328887;
"""
CENTRAL_ENERGY = 13.5
